...
class GameControllerApi {
  ...
  const GameControllerApi(this._dio, this._serializers);
  ...
  Future<Response<MyTournament>> addGameToTournament({ 
    ...
    final _path = r'/tournament/{tournamentId}/game/addGame'.replaceAll('{' r'tournamentId' '}', tournamentId.toString());
    ...
    try {
      const _type = FullType(Game);
      _bodyData = _serializers.serialize(game, specifiedType: _type);
